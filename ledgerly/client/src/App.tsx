      ...
      <section className="mx-auto flex min-h-screen max-w-7xl items-center px-6 py-20">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex gap-4">
            <button className="rounded-xl bg-emerald-500 px-5 py-3 font-medium text-black transition hover:scale-[1.02]">
              View Dashboard
            </button>
            <button className="rounded-xl border border-white/15 px-5 py-3 font-medium text-white/90 transition hover:bg-white/5">
              Learn More
            </button>
          </div>
        </div>
